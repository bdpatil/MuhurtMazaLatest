 ...
 */
public class FragmentSeasonalPooja extends ParentFragment implements BaseHttpHelper.ResponseHelper{
    private final static String SEASONAL_POOJA = "Seasonal";
    ...
    private  void  getPoojaList() throws JSONException {
        ...
        jsonObject.put("status", SEASONAL_POOJA);
    ...
    public void onSuccess(BaseResponse pResponse) {
        ...
        MMToast.getInstance().showLongToast("Seasonal Pooja", getActivity());
