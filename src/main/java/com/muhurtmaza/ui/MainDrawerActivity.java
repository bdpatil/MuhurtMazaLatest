...
public class MainDrawerActivity extends ParentActivity {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            switch (which){
                                case DialogInterface.BUTTON_POSITIVE:
                                    ...
                                    if (appPreferences.getString(AppConstants.SIGN_UP_SOURCE,"").equals(AppConstants.FACEBOOK_SIGN_UP) ) {
