...
/*
 ...
 BadgeView badge = new BadgeView(this, <View Objcet Name>);
 badge.setBadgePosition(BadgeView.POSITION_TOP_RIGHT);
 badge.setBadgeMargin(5, 5);
 badge.setBadgeBackgroundColor(Color.parseColor("#02B4CC"));
 badge.setText("5"); // 5 is count
 badge.show();
 
 */

/**
 * Created by sandeep on 14/12/15.
 */
